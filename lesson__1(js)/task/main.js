...
function t9() {
	...
	document.querySelector('.b-9').onclick = function ClearFields() {
...
function t10() {
	let data = document.querySelector('.i-10').value; // получили значение
...
function t11() {
	let data = document.querySelector('.i-11').value; // получили значение
