...
function f1( ){
	let a = document.querySelector('.i-1').value == 4;
	document.querySelector('.out-1').innerHTML = Boolean(a);
}
...
function f7(){
 let number = Math.pow(+document.querySelector('.i-71').value, +document.querySelector('.i-72').value);
 document.querySelector('.out-7').innerHTML = number;
}
...
function f8(){
	switch(+document.querySelector('.s-8').value){
		case 1:
...
function f10(){
	...
	switch (document.querySelector('.s-100').value) {
		case '6':
...
function f11(){
	switch (document.querySelector('.s-110').value) {
		case '6':
...
function f14(){
 ...
 switch (document.querySelector('.s-143').value) {
	case '+': {
		document.querySelector('.out-14').innerHTML = +document.querySelector('.i-141').value + +document.querySelector('.i-142').value;
		break;
	}
	case '-': {
		document.querySelector('.out-14').innerHTML = +document.querySelector('.i-141').value - +document.querySelector('.i-142').value;
...
function f15(){
 switch(document.querySelector('.s-153').value) {
	case '&&': {
		document.querySelector('.out-15').innerHTML = +document.querySelector('.s-151').value && +document.querySelector('.s-152').value;
		break;
	}
